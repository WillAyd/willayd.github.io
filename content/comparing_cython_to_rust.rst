...
I also want to mention `Irv Lustig <https://github.com/Dr-Irv>`_, `Brock Mendel <https://github.com/jbrockmendel>`_, `Marc Garcia <https://github.com/datapythonista>`_ and `Nathan Goldblum <https://github.com/ngoldbaum>`_ for their help in implementing and improving this article. Thanks all for your help and support!
